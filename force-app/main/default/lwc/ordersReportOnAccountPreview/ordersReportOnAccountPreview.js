...
import createContentVersion from "@salesforce/apex/OrdersReportOnAccountController.createContentVersion";
...
export default class OrdersReportOnAccountPreview extends LightningElement {
	...
	handleShowTable(event) {
		...
		let vfPageUrl = '/apex/OrdersReportOnAccount?id=' + this.recordId;
